    ...
    public class HealthBar : VisualElement, INotifyValueChanged<float>
    {
        ...
        public new class UxmlTraits : VisualElement.UxmlTraits
        {
            ...
            public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
            {
                ...
                ate.Clear();
                VisualTreeAsset vt = Resources.Load<VisualTreeAsset>("UI/InWorld/HealthBar"); //File structure VERY important
        ...
        private void FillHealth()
        {
            ...
            {
                hbForeground.style.scale = new Scale(new Vector3(value, 1, 1));
            }
            else
            {
                hbForeground.style.scale = new Scale(new Vector3(1, value, 1));
            }
        }
